// Generated by gencpp from file tello_dronet/FlightData.msg
// DO NOT EDIT!


#ifndef TELLO_DRONET_MESSAGE_FLIGHTDATA_H
#define TELLO_DRONET_MESSAGE_FLIGHTDATA_H
...
struct FlightData_
{
  ...
  typedef boost::shared_ptr< ::tello_dronet::FlightData_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::tello_dronet::FlightData_<ContainerAllocator> const> ConstPtr;

}; // struct FlightData_

typedef ::tello_dronet::FlightData_<std::allocator<void> > FlightData;

typedef boost::shared_ptr< ::tello_dronet::FlightData > FlightDataPtr;
typedef boost::shared_ptr< ::tello_dronet::FlightData const> FlightDataConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::tello_dronet::FlightData_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::tello_dronet::FlightData_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::tello_dronet::FlightData_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::tello_dronet::FlightData_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::tello_dronet::FlightData_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::tello_dronet::FlightData_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::tello_dronet::FlightData_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::tello_dronet::FlightData_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::tello_dronet::FlightData_<ContainerAllocator> >
{
  ...
  static const char* value(const ::tello_dronet::FlightData_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x8c659bf934436b7cULL;
  static const uint64_t static_value2 = 0xb2d969ddd123268aULL;
};

template<class ContainerAllocator>
struct DataType< ::tello_dronet::FlightData_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::tello_dronet::FlightData_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::tello_dronet::FlightData_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::tello_dronet::FlightData_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::tello_dronet::FlightData_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // TELLO_DRONET_MESSAGE_FLIGHTDATA_H
