// Generated by gencpp from file beginner_tutorials/FlightData.msg
// DO NOT EDIT!


#ifndef BEGINNER_TUTORIALS_MESSAGE_FLIGHTDATA_H
#define BEGINNER_TUTORIALS_MESSAGE_FLIGHTDATA_H
...
struct FlightData_
{
  ...
  typedef boost::shared_ptr< ::beginner_tutorials::FlightData_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::beginner_tutorials::FlightData_<ContainerAllocator> const> ConstPtr;

}; // struct FlightData_

typedef ::beginner_tutorials::FlightData_<std::allocator<void> > FlightData;

typedef boost::shared_ptr< ::beginner_tutorials::FlightData > FlightDataPtr;
typedef boost::shared_ptr< ::beginner_tutorials::FlightData const> FlightDataConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::beginner_tutorials::FlightData_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::beginner_tutorials::FlightData_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
// {'beginner_tutorials': ['/mnt/c/Users/jggrn/Documents/Projects/ros_workspace/src/beginner_tutorials/msg'], 'std_msgs': ['/opt/ros/kinetic/share/std_msgs/cmake/../msg']}
...
template <class ContainerAllocator>
struct IsFixedSize< ::beginner_tutorials::FlightData_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::beginner_tutorials::FlightData_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::beginner_tutorials::FlightData_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::beginner_tutorials::FlightData_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::beginner_tutorials::FlightData_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::beginner_tutorials::FlightData_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::beginner_tutorials::FlightData_<ContainerAllocator> >
{
  ...
  static const char* value(const ::beginner_tutorials::FlightData_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x8c659bf934436b7cULL;
  static const uint64_t static_value2 = 0xb2d969ddd123268aULL;
};

template<class ContainerAllocator>
struct DataType< ::beginner_tutorials::FlightData_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::beginner_tutorials::FlightData_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::beginner_tutorials::FlightData_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::beginner_tutorials::FlightData_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::beginner_tutorials::FlightData_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // BEGINNER_TUTORIALS_MESSAGE_FLIGHTDATA_H
