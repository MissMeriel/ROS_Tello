...
class CNN_out {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('collision_prob')) {
        this.collision_prob = initObj.collision_prob
      }
      else {
        this.collision_prob = 0.0;
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [collision_prob]
    bufferOffset = _serializer.float32(obj.collision_prob, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new CNN_out(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [steering_angle]
    data.steering_angle = _deserializer.float32(buffer, bufferOffset);
    // Deserialize message field [collision_prob]
    data.collision_prob = _deserializer.float32(buffer, bufferOffset);
    return data;
  }
  ...
  static datatype() {
    ...
    return 'beginner_tutorials/CNN_out';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new CNN_out(null);
    ...
    if (msg.collision_prob !== undefined) {
      resolved.collision_prob = msg.collision_prob;
    }
    else {
      resolved.collision_prob = 0.0
    }
