...
(cl:defmethod cl:initialize-instance :after ((m <CNN_out>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CNN_out)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dronet_tello-msg:<CNN_out> is deprecated: use dronet_tello-msg:CNN_out instead.")))
...
(cl:defmethod steering_angle-val ((m <CNN_out>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dronet_tello-msg:steering_angle-val is deprecated.  Use dronet_tello-msg:steering_angle instead.")
  (steering_angle m))

(cl:ensure-generic-function 'collision_prob-val :lambda-list '(m))
(cl:defmethod collision_prob-val ((m <CNN_out>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dronet_tello-msg:collision_prob-val is deprecated.  Use dronet_tello-msg:collision_prob instead.")
  (collision_prob m))
