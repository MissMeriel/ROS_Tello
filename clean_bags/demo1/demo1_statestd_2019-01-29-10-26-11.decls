...
ppt ..state(geometry_msgs/TransformStamped):::ENTER
	ppt-type enter
	variable param0
		var-kind variable
		rep-type hashcode
...
ppt ..state(geometry_msgs/TransformStamped):::EXIT0
	ppt-type subexit
	variable param0
		var-kind variable
		rep-type hashcode
...
ppt ..velocity(geometry_msgs/TransformStamped):::ENTER
	ppt-type enter
	variable param0
		var-kind variable
		rep-type hashcode
...
ppt ..velocity(geometry_msgs/TransformStamped):::EXIT0
	ppt-type subexit
	variable param0
		var-kind variable
		rep-type hashcode
